...
<div class="p-4 md:p-10 max-w-[1200px] mx-auto min-h-screen">
    <div class="mb-10 text-center">
        <h1 class="text-3xl font-black text-gray-900 dark:text-white uppercase tracking-tighter">Seat Plan Generator</h1>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-[2.5rem] shadow-2xl p-10 border border-gray-100 dark:border-gray-700">
        <form action="{{ route('seat-plans.generate') }}" method="POST" target="_blank">
            @csrf
