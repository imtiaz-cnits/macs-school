...
<head>
    ...
    <title>Academic Testimonial - {{ $student->student_name }}</title>
    <style>
        @page {
            size: a4 landscape;
            margin: 0;
...
<body>
    @php
        ...
        if (!isset($certNo) || !$certNo) {
            $certNo = 'MACS/TEST/' . ($student->sessionYear->session_name ?? date('Y')) . '/' . str_pad($student->id, 4, '0', STR_PAD_LEFT);
        }
    ...
    <div class="cert-container">
        ...
        <!-- Certificate Title -->
        <div class="title-box">
            <span class="title-text">ACADEMIC TESTIMONIAL</span>
        </div>
        ...
        <p class="body-paragraph">
            To the best of our knowledge, he/she bears a good moral character and never took part in any activities subversive of the state or of school discipline.
        </p>

        <p class="body-paragraph" style="margin-bottom: 12px;">
            I wish him/her every success, flourishing accomplishments, and a bright future in life.
        </p>
