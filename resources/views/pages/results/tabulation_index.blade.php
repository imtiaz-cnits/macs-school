...
<div x-data="tabulationGenerator()" class="w-full min-h-screen">
    ...
    <div class="mb-8 flex flex-col md:flex-row justify-between items-center gap-4 no-print">
        <div>
            ...
            <p class="text-sm font-medium text-gray-555 dark:text-gray-400 mt-1">Generate class-wise academic result tabulation summary sheet</p>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-themeNavy border border-gray-100 dark:border-white/[0.06] rounded-3xl p-6 shadow-sm hover:shadow-md transition-all duration-300">
        <form action="{{ route('results.tabulation.generate') }}" method="POST" target="_blank" @submit="
