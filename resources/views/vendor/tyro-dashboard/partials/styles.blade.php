...
<style>
    ...
    *::after {
    ...
    .sidebar.collapsed .sidebar-section:nth-last-child(1):hover .sidebar-submenu,
    .sidebar.collapsed .sidebar-section:nth-last-child(2):hover .sidebar-submenu,
    .sidebar.collapsed .sidebar-section:nth-last-child(3):hover .sidebar-submenu {
        top: auto !important;
        bottom: 0 !important;
    }
    ...
    .sidebar.collapsed .sidebar-section-title-content {
        justify-content: center !important;
        gap: 0 !important;
    }

    .sidebar.collapsed .sidebar-link svg,
    .sidebar.collapsed .sidebar-section-title-icon {
        opacity: 1 !important;
        margin: 0 !important;
    }
    ...
    #sidebar.collapsed .sidebar-section-title .sidebar-text {
    ...
    .desktop-collapse-btn .icon-collapsed {
        display: none !important;
    }
    .desktop-collapse-btn .icon-expanded {
        display: block !important;
    }

    #sidebar.collapsed ~ .main-content .desktop-collapse-btn .icon-expanded {
        display: none !important;
    }
    #sidebar.collapsed ~ .main-content .desktop-collapse-btn .icon-collapsed {
        display: block !important;
    }
    ...
    /* Globally override page content container max-widths to be wider and consistent */
    .page-content > div[class*="max-w-[1400px]"],
    .page-content > div[class*="max-w-[1200px]"],
    .page-content > div[class*="max-w-[1000px]"],
    .page-content > div[class*="max-w-[1600px]"],
    .page-content > div[class*="max-w-7xl"] {
